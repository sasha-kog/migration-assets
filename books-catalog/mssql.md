...
description: Overview of the MSSQL integration.
icon: database
---
...
{% hint style="success" %}
The MSSQL integration supports **discovery**. Once connected, you can browse available services and entities directly from Kognitos, then enable the specific actions your automations need. See [Custom Actions](README.md#custom-actions) for setup instructions.
{% endhint %}
...
Add a name for the connection. You'll be prompted for [**authentication**](mssql.md#authentication) details if needed. Then, click on <kbd>**Connect**</kbd>.
{% endstep %}
{% endstepper %}
